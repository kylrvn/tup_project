...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2024 at 10:45 PM
...
INSERT INTO `tbl_acknowledged` (`ID`, `FacultyID`, `Schedule`, `Acknowledged`, `ForVerif`, `ForVerifStatus`, `ForVerifReason`, `Date_Acknowledged`) VALUES
(1, 1, 'Mar 11, 2024 - Mar 16, 2024', 1, 0, 0, NULL, '2024-03-08 14:51:23'),
(2, 57, 'Mar 11, 2024 - Mar 16, 2024', 1, 1, 0, 'TESTING', '2024-03-08 15:18:38'),
(3, 55, 'Mar 11, 2024 - Mar 16, 2024', 1, 1, 0, 'ESSSSSS', '2024-03-08 15:18:38');
...
--
-- Table structure for table `tbl_encoded_schedule`
--

CREATE TABLE `tbl_encoded_schedule` (
  `ID` int(11) NOT NULL,
  `facultyID` varchar(50) DEFAULT NULL,
  `schoolTerm` varchar(50) DEFAULT NULL,
  `schoolYear` varchar(50) DEFAULT NULL,
  `approvedPH` tinyint(1) NOT NULL DEFAULT 0,
  `approvedHR` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(3, 57, 'DTR', '2024-03-13 08:00:00', '2024-03-13 11:15:00', NULL, '2024-03-08 17:41:00', '2024-03-13 09:33:13', '2024-04-20 00:00:00'),
(4, 57, 'DTR', NULL, NULL, NULL, NULL, '2024-03-14 09:33:13', '2024-04-20 00:00:00'),
...
(6, 57, 'DTR', NULL, '2024-03-16 10:45:00', NULL, NULL, '2024-03-16 00:00:00', '2024-04-20 00:00:00');
...
(7, '57', 'Test Room', '5', 'tuesday', '2024-04-13', '2023 to 2024', '1st', 'AM', '09:45:00', '11:45:00', '1 '),
(8, '57', 'Test Room', '6', 'tuesday', '2024-04-13', '2023 to 2024', '1st', 'PM', '14:15:00', '16:15:00', '1 '),
...
--
-- Indexes for table `tbl_encoded_schedule`
--
ALTER TABLE `tbl_encoded_schedule`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `tbl_encoded_schedule`
--
ALTER TABLE `tbl_encoded_schedule`
