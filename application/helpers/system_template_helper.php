 ...
 <img class="animation__wobble" src="<?= base_url()?>assets/images/Logo/logo.jpg"  height="200" width="200"> 
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="Dashboard" class="brand-link" style="background-color:#9f3a3b;">
      <img src="<?= base_url()?>assets/images/Logo/tuplogo.png"  class="brand-image img-circle elevation-3" style="opacity: .8">
      <span style="font-size:12px;" class="brand-text font-weight-light">Daily Time Record Portal System</span>
    </a>
    ...
    <!--     <div class="image">
        ...
        <div class="info text-wrap">
          <a style="font-weight:bold;color:black;" href="<?= base_url()?>/user_profile/index/<?=$session->U_ID?>" class="d-block"> Welcome, <br><?=$session->Fname?> <?=$session->Mname?> <?=$session->Lname?> </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item menu-open">
            ...
            <li class="nav-item" >
                <a style="color:black;" href="<?= base_url()?>Dashboard" class="nav-link <?= (sidebar($menubar, ['Dashboard'])) ? 'active' : '' ?>">
           ...
           <li class="nav-item">
                <a style="color:black;" href="<?= base_url()?>schedule" class="nav-link <?= (sidebar($menubar, ['schedule'])) ? 'active' : '' ?>">
                  <i class="fas fa-list nav-icon"></i>
                  <p>Schedule</p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a style="color:black;" href="<?= base_url()?>create_user" class="nav-link <?= (sidebar($menubar, ['create_user'])) ? 'active' : '' ?>">
                  <i class="fas fa-list nav-icon"></i>
                  <p>Create User</p>
                </a>
            </li>
          ...
          <li class="nav-item">
                <a style="color:black;" href="<?= base_url()?>faculty_schedule" class="nav-link <?= (sidebar($menubar, ['Faculty_schedule'])) ? 'active' : '' ?>">
                  <i class="fas fa-list nav-icon"></i>
                  <p>Upload Schedule</p>
                </a>
          ...
          <li class="nav-item">
                <a style="color:black;" href="<?= base_url()?>scan" class="nav-link <?= (sidebar($menubar, ['scan'])) ? 'active' : '' ?>">
                  <i class="fas fa-list nav-icon"></i>
                  <p>Scan</p>
                </a>
